...
class ScanResultTest {
    ...
    val old = ScanResult(
        ...
        hosts = listOf(
            Host(IP("10.0.0.1"), "host1", Status.UP, Instant.fromEpochSeconds(100)),
            Host(IP("10.0.0.2"), "host2", Status.UP, Instant.fromEpochSeconds(100)),
            Host(IP("10.0.0.3"), "host3", Status.DOWN, Instant.fromEpochSeconds(100)),
    ...
    val current = ScanResult(
        ...
        hosts = listOf(
            Host(IP("10.0.0.1"), "host1", Status.UP),
